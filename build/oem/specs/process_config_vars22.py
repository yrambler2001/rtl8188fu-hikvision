...
AXES = {
    ...
    'tpos': _ax('TPOS', ['unsigned int', 'u32', 'int', 'long', 'unsigned long', 'size_t', '_Bool', 'unsigned char']),
    'tn': _ax('TN', ['u32', 'unsigned int', 'int', 'long', 'unsigned long', 'size_t']),
