...
AXES = {
    'g': _ax('G', ['pos | n', '(pos | n) | (pos & n)', '(pos | n) == 1',
                   '(n | pos) | (n & pos)']),
    'tpos': _ax('TPOS', ['unsigned int', 'int', 'long', 'unsigned long', 'u32']),
    'tn': _ax('TN', ['unsigned long', 'long', 'u32', 'unsigned int', 'int']),
