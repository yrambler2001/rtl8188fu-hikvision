# process_config_vars - stage 31: the last five instructions, everything crossed.
#
...
GT = [("a%d_%d" % (i, j), _arm(a, b))
      for i, a in enumerate(_TRUE[:2]) for j, b in enumerate(_FALSE[:2])]
...
AXES = {
    ...
    'g': [('plain', '(pos | n) | (pos & n)'),
          ...
          ('icast1', '((int)(pos | n)) | (pos & n)'),
          ('icast2', '(pos | n) | ((int)(pos & n))')],
